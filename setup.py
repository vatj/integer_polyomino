...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        # test_bin = os.path.join(self.build_temp, 'integer_polyomino_test')
...
setup(
    ...
    description='Study of the Genotype-Phenotype Map in the pseudo-deterministic Polyomino Model',
    long_description='',
